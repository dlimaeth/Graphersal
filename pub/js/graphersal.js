...
(function(global, document) {
    ...
    function _addNode(cx, cy, graph) {
        ...
        nodeElement.setAttribute('r', `${_node_radius}`)
    ...
    function _setEdge(node1, node2, isDirected) {
        ...
        let d1 = (x2 - x1) / norm
        let d2 = (y2 - y1) / norm
        x1 = x1+_node_radius*d1;
        y1 = y1+_node_radius*d2;
        x2 = x2-_node_radius*d1;
        y2 = y2-_node_radius*d2;
    ...
    global.Graphersal = global.Graphersal || Graphersal
